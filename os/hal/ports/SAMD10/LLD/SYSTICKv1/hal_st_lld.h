 ...
 */
#if !defined(SAMD10_ST_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define SAMD10_ST_IRQ_PRIORITY              0
#endif
 ...
 */
#if !defined(SAMD10_ST_USE_TIMER) || defined(__DOXYGEN__)
#define SAMD10_ST_USE_TIMER                  2
#endif
/** @} */
